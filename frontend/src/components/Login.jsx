...
const Login = () => {
  ...
  const submitForm = (e) => {
    ...
    if (email == "world@mealmate.com" && password == "password123") {
      return navigate("/createmealplan")
    }
    if (email == "helloworld@mealmate.com" && password == "password123") {
      return navigate("/createmealplan")
    }
  }
    ...
    <form onSubmit={submitForm} className="max-w-sm mx-auto pt-20 pb-20">
      ...
      <div className="flex items-start mb-5">
        <div className="flex items-center h-5">
          <input 
          id="remember" type="checkbox" className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800" required />
        </div>
